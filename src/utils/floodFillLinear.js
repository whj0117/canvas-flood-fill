...
export function floodFillLinear(canvas, x, y, fillColor, tolerance) {
  /**
   * 相关数据准备
   */
  ...
  console.log('pixelsChecked', pixelsChecked);
  ...
  if (startColor[0] == 0 && startColor[1] == 0 && startColor[2] == 0 && startColor[3] == 255) {
    return;
  }
